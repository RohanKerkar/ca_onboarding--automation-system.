...
import java.awt.*;
public class formUI_2 implements FocusListener{
  JTextField nameField, emailField, phoneField, collegeField, cityField;
    ...
    formUI_2()
    {
        ...
        frame.getContentPane().setBackground(new Color(173, 216, 230));  //new Color(80, 0, 128)
        ...
        formPanel.setBounds(500, 10, 490, 740);   //230 // w-460
        frame.add(formPanel);
      ...
      formPanel.add(logoLabel); 
        ...
        collegeLabel.setFont(new Font("SansSerif",Font.BOLD,16));        //40 and 30
        ...
        String password=new String("db_password");
